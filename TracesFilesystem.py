...
def parse_filename(fname, size):
    ...
    return hexas  # return   map( hex_to_raw                     , hexas   )
...
def test():
    tfs = TracesFilesystem("/home/traces/secmatv1_2006_04_0809");  # /!\ Not the table to use for the contest
    for i in range(10):
